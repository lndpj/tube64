...
void CPP_setup_game(void);									//OK
void CPP_game(void);										//OK
void CPP_LoadAllData(char *a2);								//OK
...
void *CPP_MyAlloc(int a2);									//OK*
int CPP_LoadData(char *a3);								//OK
void CPP_FreeData(char *a1);								//OK
void CPP_MyFree(void *a1);									//OK*
int CPP_LoadFileAt(char *a1, char *a2);							//OK
int CPP_RncFileLength(char *a1);								//OK
FILE *CPP_MyOpen(char *a1, int a2);							//OK
int CPP_MyRead(FILE *a1, void *a2, int a3);							//OK
int CPP_MyClose(FILE *a1);								//OK
...
int CPP_SaveFileAt(char *a1, void *a2, int a3);				//OK
int CPP_MyWrite(FILE *a1, void *a2, int a3);				//OK
...
unsigned int CPP_save_score(u8 a1, u8 a2, char *a3);	//OK
...
void CPP_setup_game(void) //FINAL
{
  glass_map = (int)(intptr_t)byte_2A26BC;
  ...
  colour_lookup = CPP_FindColor((u8 *)(SP<u8>)palette, 0, 0, 0);
  byte_22EDA1   = CPP_FindColor((u8 *)(SP<u8>)palette, 0x3Fu, 0x3Fu, 0x3Fu);
  byte_22EDA2   = CPP_FindColor((u8 *)(SP<u8>)palette, 0x3Fu, 0, 0);
  byte_22EDA3   = CPP_FindColor((u8 *)(SP<u8>)palette, 0, 0x3Fu, 0);
  byte_22EDA4   = CPP_FindColor((u8 *)(SP<u8>)palette, 0, 0, 0x3Fu);
  byte_22EDA5   = CPP_FindColor((u8 *)(SP<u8>)palette, 0x3Fu, 0x3Fu, 0);
  byte_22EDA6   = CPP_FindColor((u8 *)(SP<u8>)palette, 0, 0x3Fu, 0x3Fu);
  byte_22EDA7   = CPP_FindColor((u8 *)(SP<u8>)palette, 0x3Fu, 0, 0x3Fu);
  ...
  level = (SP<int>)CPP_MyAlloc(66136);
...
{
 for(int i=0;i<2;i++) //free tmaps 0,1
 {
  u32 a=(u32)(uintptr_t)&MINIBuf[(44*i)+28];
  CPP_MyFree((void*)(SP<void>)(u32)**(SP<u32>)a);
 }

 Free((void*)(SP<void>)fade_out);
}
...
void CPP_FreeAllData(char *a1) //FINAL
{
  while ( *(UA<u32> *)(a1 + 28) )
  {
    CPP_FreeData(a1);
...
{
  CPP_MyFree((void*)(SP<void>)level); //ok

  MY_FreeSound();
  MY_FreeMusic();

  CPP_reset_host();
  CPP_FreeAllData(startup_files);
}
...
int CPP_save_game(void) //FINAL
{
  ...
  result = CPP_SaveFileAt(aDataHiscoreDat, (void*)(SP<void>)high_scores, 832);
  if ( result != 832 )
    file_error = 1;
  return result;
}
...
unsigned int CPP_draw_the_winner(char a1) //FINAL
{
  ...
  {
    if ( a1 == 1 )
      sprintf((char*)v3, (char*)aCongratulation_1); //((void (__cdecl *)(char *, char *))sprintf)(v3, aCongratulation_1);
    else
  ...
  for ( i = 0; ; ++i )
  {
    ...
    {
      v8 = (u8)v3[(u16)i] + 1952;
      v4 = (u8 *)(SP<u8>)(((u16)v8 << 6) + block_data);
      for ( j = 0; (u16)j < 8u; ++j )
      {
        v6 = 320 * (u16)j;
        for ( k = 0; (u16)k < 8u; ++k )
...
int CPP_who_won(void) //FINAL
{
  if ( fading == 1 )
  {
    if ( CPP_FadePalette256((u8 *)(SP<u8>)palette, 0x18u, 1) >= 24 )
      fading = 0;
  }
  else if ( fading == 2 )
  {
  ...
  {
    CPP_ClearScreenMCGA(/*200,*/ (void *)(SP<void>)WScreen, 0xC8u, 0);
  }
...
unsigned int CPP_save_score(u8 a1, u8 a2, char *a3) //FINAL
{
  u16 *v3; // eax
  u16 *v4; // edx
  char v5; // bl
  ...
  v15 = (u16 *)(SP<u16>)((a2 << 6) + 64 + high_scores);
...
char CPP_draw_enter_score(u8 a1, u8 a2) //FINAL
{
  ...
  for ( i = 0; ; ++i )
  {
    ...
    {
      v13 = (u8)v8[i] + 1952;
      v9 = (u8 *)(SP<u8>)(((u16)v13 << 6) + block_data);
      for ( j = 0; j < 8u; ++j )
      {
        v11 = 320 * j;
        for ( k = 0; k < 8u; ++k )
...
int CPP_enter_scores(void) //FINAL
{
  ...
  else
  {
    ...
    while ( the_score[(u8)byte_220C44] > v12 && v13 > 1u )
    {
      v12 = 0;
      v11 = 1;
      for ( i = (u16 *)(SP<u16>)((v13 << 6) + 40 + high_scores); *i != 1998; --i )
      {
  ...
  else if ( fading == 2 && CPP_FadePalette256(0, 0x18u, 1) >= 24 )
  {
    ...
    game_mode = 2;
    hiscore_ticks = 0;
    hi_look = (int)(intptr_t)&hiscore_lookup;
    level_line[0] = 987;
...
int CPP_high_tube(void) //FINAL Знакозависимая функция. Принудительно задал signed там, где надо. Иначе корректно работала только при all chars signed в настройках компилятора.
{
  ...
  if ( !hiscore_ticks )
  {
    if ( *(u8 *)(SP<u8>)hi_look == 100 )
      hi_look = (int)(intptr_t)&hiscore_second[0]; //fix [0] pointer
    v0 = (signed char *)(SP<signed char>)hi_look++;
    vx[0] = *v0;
    v1 = (signed char *)(SP<signed char>)hi_look++;
    vy[0] = *v1;
    v2 = (signed char *)(SP<signed char>)hi_look++;
    hiscore_ticks = *v2;
  }
...
i16 CPP_draw_hiscore(void) //FINAL
{
  ...
  {
    result = CPP_FadePalette256((u8 *)(SP<u8>)palette, 0x18u, 1);
    if ( result >= 24 )
      fading = 0;
  }
  return result;
...
u16 CPP_move_it(int a1, int a2, int a3, i16 a4, i16 a5, int a6) //FINAL
{
  ...
  v19 = (u32 *)(SP<u32>)*((u32 *)v21 + 2);      //v19 = (u32 *)*((u32 *)v21 + 2);
  v23 = (u32 *) polypoints;
  v26 = (a1 >> 5) & 0x7FF;
  v27 = a4 & 0x7FF;
  v28 = a5 & 0x7FF;
  ...
  if ( result )
  {
    ...
    v25 = 0;
    for ( j = (char *)(SP<char>)*((u32 *)v21 + 3); ; j += 15 )
    {
      result = v25;
...
int CPP_draw_ships(void) //FINAL
{
  ...
  if ( (u8)no_players <= 1u )
  {
    ...
    for ( i = 0; ; ++i )
    {
      ...
      if ( !*(UA<u32> *)(u32*)(SP<u32>)v3 || i >= 0x60u )
        break;

      CPP_move_it(
        *(u16 *)(SP<u16>)(*(UA<u32> *)(u32*)(SP<u32>)v3 + 4),
        *(u16 *)(SP<u16>)(*(UA<u32> *)(u32*)(SP<u32>)v3 + 6) - 1792,
        *(u16 *)(SP<u16>)(*(UA<u32> *)(u32*)(SP<u32>)v3 + 8),
        HIWORD(*(UA<u32> *)(u32*)(SP<u32>)(*(UA<u32> *)(u32*)(SP<u32>)v3 + 8)),
        HIWORD(*(UA<u32> *)(u32*)(SP<u32>)(*(UA<u32> *)(u32*)(SP<u32>)v3 + 10)),
        *(u8 *)(SP<u8>)(*(UA<u32> *)(u32*)(SP<u32>)v3 + 16));
  ...
  {
    v1 = (int)(intptr_t)draw_items;

    CPP_set_scroll((int)(u16)word_25677C[0] >> 5);
    CPP_setup_vecs(WScreen, 0, 320, 160, 200);

    for ( j = 0; *(UA<u32> *)(u32*)(SP<u32>)v1 && j < 0x60u; ++j )
    {
      CPP_move_it(
        *(u16 *)(SP<u16>)(*(UA<u32> *)(u32*)(SP<u32>)v1 + 4),
        *(u16 *)(SP<u16>)(*(UA<u32> *)(u32*)(SP<u32>)v1 + 6) - 1792,
        *(u16 *)(SP<u16>)(*(UA<u32> *)(u32*)(SP<u32>)v1 + 8),
        HIWORD(*(UA<u32> *)(u32*)(SP<u32>)(*(UA<u32> *)(u32*)(SP<u32>)v1 + 8)),
        HIWORD(*(UA<u32> *)(u32*)(SP<u32>)(*(UA<u32> *)(u32*)(SP<u32>)v1 + 10)),
        *(u8 *)(SP<u8>)(*(UA<u32> *)(u32*)(SP<u32>)v1 + 16));
    ...
    v2 =(int)(intptr_t)byte_256994;

    for ( k = 0; ; ++k )
    {
      result = v2;

      if ( !*(UA<u32> *)(u32*)(SP<u32>)v2 || k >= 0x60u )
        break;

      CPP_move_it(
        *(u16 *)(SP<u16>)(*(UA<u32> *)(u32*)(SP<u32>)v2 + 4),
        *(u16 *)(SP<u16>)(*(UA<u32> *)(u32*)(SP<u32>)v2 + 6) - 1792,
        *(u16 *)(SP<u16>)(*(UA<u32> *)(u32*)(SP<u32>)v2 + 8),
        HIWORD(*(UA<u32> *)(u32*)(SP<u32>)(*(UA<u32> *)(u32*)(SP<u32>)v2 + 8)),
        HIWORD(*(UA<u32> *)(u32*)(SP<u32>)(*(UA<u32> *)(u32*)(SP<u32>)v2 + 10)),
        *(u8 *)(SP<u8>)(*(UA<u32> *)(u32*)(SP<u32>)v2 + 16));
      v2 += 4;
    }
  }
  return result;
...
void CPP_DrawSpriteVres256(i16 a1 /*dx*/ , int a2 /*ecx*/, int a3 /*ebx*/, char *a4 /*esi*/ , u8 a5, char a6) //FINAL
{
  ...
  if ( a3 >= 0 )
  {
    if ( a3 + (u8)a1 >= GraphicsWindowWidth )
    {
      if ( DrawFlags )
      {
        if ( (DrawFlags & 1) != 0 )
        {
          if ( (DrawFlags & 2) != 0 )
          {
            ...
            {
              v77 = (u8)a1 + a3;
              v78 = (u8 *)(SP<u8>)(ScreenWidth * (HIBYTE(a1) + a2) + v77 + v6);
              v79 = 0;
          ...
          {
            v83 = (u8)a1 + a3;
            v84 = (u8 *)(SP<u8>)(ScreenWidth * a2 + v83 + v6);
            v85 = 0;
        ...
        {
          v89 = (u8 *)(SP<u8>)(ScreenWidth * (HIBYTE(a1) + a2) + a3 + v6);
          v90 = 0;
      ...
      else
      {
        ...
        if ( v69 >= 0 )
        {
          v70 = (u8 *)(SP<u8>)(ScreenWidth * a2 + v68);
          BYTE1(v69) = HIBYTE(a1);
          v130 = v69;
          v71 = v70;
          v72 = 0;
    ...
    else if ( (DrawFlags & 1) != 0 )
    {
      if ( (DrawFlags & 2) != 0 )
      {
        v7 = (u8 *)(SP<u8>)(ScreenWidth * (HIBYTE(a1) + a2) + (u8)a1 + a3 + v6);
        v8 = 0;
        v9 = -1;
        v10 = v7;
        do
      ...
      {
        v14 = (u8 *)(SP<u8>)(ScreenWidth * a2 + (u8)a1 + a3 + v6);
        v15 = 0;
        v16 = -1;
        v17 = v14;
        do
    ...
    else if ( DrawFlags )
    {
      if ( (DrawFlags & 2) != 0 )
      {
        v28 = (char *)(SP<char>)(ScreenWidth * (HIBYTE(a1) + a2) + a3 + v6);
        v29 = 0;
        v30 = -1;
        v31 = v28;
        do
      ...
      {
        v35 = GlassMap;
        v36 = (u8 *)(SP<u8>)(ScreenWidth * a2 + a3 + v6);
        v37 = 0;
        v38 = v36;
        do
        {
      ...
      {
        v41 = (u8 *)(SP<u8>)(ScreenWidth * a2 + a3 + v6);
        v42 = 0;
        v140 = v41;
        v138 = HIBYTE(a1);
        for ( i = a5; ; i = a5 )
      ...
      {
        v49 = (char *)(SP<char>)(ScreenWidth * a2 + a3 + v6);
        v141 = (u8*)v49;
        v139 = HIBYTE(a1);
        do
        {
          ...
          {
            v129 = a4;
            v54 = (uintptr_t)v49 - (uintptr_t)v141; //v54 = (unsigned int)v49 - (unsigned int)v141;
            do
            {
              v55 = v141;
              v141 += ScreenWidth;
      ...
      {
        v56 = (char *)(SP<char>)(ScreenWidth * a2 + a3 + v6);
        v57 = 0;
        v58 = -1;
        v59 = v56;
        do
      ...
      {
        v61 = (char *)(SP<char>)(ScreenWidth * a2 + a3 + v6);
        v62 = 0;
        v63 = -1;
        v64 = v61;
        do
    ...
    {
      v21 = (char *)(SP<char>)(ScreenWidth * a2 + a3 + v6);
      v22 = 0;
      v23 = -1;
      v24 = v21;
      do
  ...
  if ( !DrawFlags )
  {
    ...
    if ( (u8)a1 <= v95 )
      return;
    v96 = (u8 *)(SP<u8>)(ScreenWidth * a2 + v6);
    BYTE1(v95) = HIBYTE(a1);
    v97 = v96;
    v134 = v95;
    v98 = 0;
...
LABEL_179:
  ...
  if ( (DrawFlags & 1) == 0 )
  {
    ...
    if ( (u8)a1 <= v115 )
      return;
    v116 = (u8 *)(SP<u8>)(ScreenWidth * (HIBYTE(a1) + a2) + v6);
...
LABEL_225:
  ...
  if ( (DrawFlags & 2) != 0 )
  {
    v103 = (u8 *)(SP<u8>)(ScreenWidth * (HIBYTE(a1) + a2) + (u8)a1 + a3 + v6);
    v104 = 0;
    v105 = (u8)a1 + a3 + 1;
    if ( v105 >= 0 )
    {
  ...
  {
    v109 = (u8 *)(SP<u8>)(ScreenWidth * a2 + (u8)a1 + a3 + v6);
    v110 = 0;
    v111 = (u8)a1 + a3 + 1;
    if ( v111 >= 0 )
    {
...
void CPP_DrawBoxBPP(int a1, int a2, int a3, int a4, char a5, char a6)
{
  ...
  v9 = (char *)(SP<char>)(WScreen + GraphicsWindowLeft + v8 + v7);
  v10 = a4;
  v11 = ScreenWidth - a3;
  v12 = a6 & 3;
  switch ( a6 & 3 )
...
int CPP_add_anims(u8 a1, int a2, u16 a3) //FINAL
{
  ...
  v7 = (int)(intptr_t)anim_blks; //2289064; //22EDA8 HARDCODED !!!

  for ( i = 0; i < 0x3E8u; ++i )
  {
    if ( *(UA<u16> *)(u16*)(SP<u16>)(v7 + 8) >= a3 && *(u16 *)(SP<u16>)(v7 + 8) < a3 + 32 )
    {
      v6 = 8 * (*(u16 *)(SP<u16>)(v7 + 8) - a3) + a2;
...
char CPP_scroll_tube(char a1, u8 a2) //FINAL
{
  ...
  for ( i = 0; i < 0x20u; ++i )
  {
    ...
    v10 = (u32 *)(SP<u32>)((v12 << 6) + block_data);
    for ( j = 0; j < 8u; ++j )
    {
      *(UA<u32> *)(u32*)(SP<u32>)(tube_graphics + v6) = *v10;
      *(UA<u32> *)(u32*)(SP<u32>)(tube_graphics + v6 + 4) = v10[1];
      v6 += 256;
      v10 += 2;
    }
    result = i;
...
int CPP_remove_effect(u8 a1) //FINAL
{
  ...
  while ( *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * a1 + 4) && a1 < 0x63u )
  {
    *(UA<u16> *)(u16*)(SP<u16>)(6 * a1 + effect_list + 2) = *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * (a1 + 1) + 2);
    *(UA<u16> *)(u16*)(SP<u16>)(6 * a1 + effect_list)     = *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * (a1 + 1));
    *(UA<u16> *)(u16*)(SP<u16>)(6 * a1 + effect_list + 4) = *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * (a1 + 1) + 4);
    ++a1;
  }
  *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * a1 + 2) = 0;
  *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * a1) = 0;
  result = effect_list + 6 * a1;
  *(UA<u16> *)(u16*)(SP<u16>)(result + 4) = 0;
  return result;
}
...
int CPP_check_effects(u8 a1) //FINAL
{
  ...
  if ( vy[a1] > 0 )
  {
    ...
    for ( i = 0; ; ++i )
    {
      ...
      if ( !*(UA<u16> *)(u16*)(SP<u16>)(result + 4) )
        break;
      if ( *(u16 *)(SP<u16>)(effect_list + 6 * i) <= (i16)v7
        && *(u16 *)(SP<u16>)(effect_list + 6 * i) >= (i16)v7 - 4
        && *(UA<i16> *)(i16*)(SP<i16>)(effect_list + 6 * i + 4) > 0 )
      {
        if ( *(UA<i16> *)(i16*)(SP<i16>)(effect_list + 6 * i + 4) <= 33 )
        {
          v5 = *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * i + 4);
          switch ( v5 )
          {
            case 1:
            case 2:
            ...
            case 48:
            case 49:
              CPP_add_alien(a1, v5 - 34, v11, *(u8 *)(SP<u8>)(effect_list + 6 * i + 2));
              break;
            default:
              continue;
          }
        ...
        {
          v11 += ((i16)v7 + 1024 - *(u16 *)(SP<u16>)(effect_list + 6 * i)) % 1024;
          v4 = *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * i + 4);
          switch ( v4 )
          {
            case 1:
            case 2:
            ...
            case 48:
            case 49:
              CPP_add_alien(a1, v4 - 34, v11, *(u8 *)(SP<u8>)(effect_list + 6 * i + 2));
              break;
            default:
              break;
          }
  ...
  else
  {
    ...
    for ( j = 0; ; ++j )
    {
      ...
      if ( !*(UA<u16> *)(u16*)(SP<u16>)(result + 4) )
        break;
      if ( *(u16 *)(SP<u16>)(effect_list + 6 * j) >= (i16)v6
        && *(u16 *)(SP<u16>)(effect_list + 6 * j) <= (i16)v6 + 4
        && *(UA<i16> *)(i16*)(SP<i16>)(effect_list + 6 * j + 4) > 0 )
      {
        if ( *(UA<i16> *)(i16*)(SP<i16>)(effect_list + 6 * j + 4) <= 33 )
        {
          v3 = *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * j + 4);
          switch ( v3 )
          {
            case 1:
            case 2:
            ...
            case 48:
            case 49:
              CPP_add_alien(a1, v3 - 34, v10, *(u8 *)(SP<u8>)(effect_list + 6 * j + 2));
              break;
            default:
              continue;
          }
        ...
        {
          v10 -= (*(u16 *)(SP<u16>)(effect_list + 6 * j) + 1024 - (i16)v6) % 1024;
          v2 = *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * j + 4);
          switch ( v2 )
          {
            case 1:
            case 2:
            ...
            case 48:
            case 49:
              CPP_add_alien(a1, v2 - 34, v10, *(u8 *)(SP<u8>)(effect_list + 6 * j + 2));
              break;
            default:
              break;
          }
...
int CPP_do_anims(u8 a1) //FINAL
{
  ...
  for ( i = 0; i < 0xC8u; ++i )
  {
    ...
    if ( *((u32 *)v2 + 1) )
      CPP_draw_block(*(UA<u32> *)v2, *(UA<u16>*)(u32*)(SP<u32>)*(SP<u32>)(v2+4) /* **(u16**)(v2 + 4) */ ); //misaligned data 2-nd depointer

    result = (int)(intptr_t)v2;
    v2 += 8;
  }
  return result;
}
...
int CPP_count_swamp_anims(u8 a1)
{
  ...
  while ( v3 < 0xC8u )
  {
    if ( *((u32 *)v2 + 1) && CPP_swamp_block( *(u16*)(SP<u16>)*(u32*)(SP<u32>)(v2+4) /* **(SP<u16>)(v2 + 4) */ ))
      ++v4;
...
_BOOL1 CPP_load_level(u8 a1)
{
  ...
  return CPP_LoadFileAt(v2, (char *)(SP<char>)level) == 66136;
}
...
int CPP_next_frames(void) //FINAL
{
  ...
  v1 = (int)(intptr_t)anim_blks;
  for ( i = 0; i < 0x3E8u; ++i )
  {
    if ( *(UA<u16> *)(u16*)(SP<u16>)(v1 + 8) != 0xFFFF )
    {
      v2 = (u16*)(SP<u16>)*(UA<u32> *)(u32*)(SP<u32>)(v1+2); // *(u16**)(v1 + 2); //misaligned
      v4 = *(UA<u16> *)(u16*)(SP<u16>)(v1 + 6) + 1;
      if ( *(UA<i32> *)&v2[*(u16 *)(SP<u16>)(v1 + 6)] >> 16 == -1 )
      {
        v4 = 0;
        *(UA<u16> *)(u16*)(SP<u16>)v1 = *v2;
      }
      else
      {
        *(UA<u16> *)(u16*)(SP<u16>)v1 = v2[v4];
      }
      *(UA<u16> *)(u16*)(SP<u16>)(v1 + 6) = v4;
      *(UA<u16> *)(u16*)(SP<u16>)(2 * *(u16 *)(SP<u16>)(v1 + 8) + level) = *(UA<u16> *)(u16*)(SP<u16>)v1;
    }
    result = v1;
    v1 += 10;
  }
...
void CPP_omni_map(int a1, int a2, i16 a3) //FINAL
{
  ...
  v14 = v4 >> 5;
  v5 = (u16 *)(SP<u16>)(a1 + 2 * (tube_scroll_x + 320 * tube_scroll_y));
  HIWORD(v6) = 0;
  v7 = (int *)(SP<int>)vec_screen;
  ...
  do
  {
    ...
    do
    {
      ...
      BYTE1(v8) += HIBYTE(a3);
      BYTE1(v6) += HIBYTE(a3);
      LOBYTE(v3) = *(u8 *)(SP<u8>)(v8 + a2);
      BYTE1(v3) = *(u8 *)(SP<u8>)(v6 + a2);
      v9 = v3 SHL16;
      LOWORD(v6) = v5[1];
      LOBYTE(v8) = a3 + *v5;
      LOBYTE(v6) = a3 + v6;
      ...
      BYTE1(v6) += HIBYTE(a3);
      LOBYTE(v9) = *(u8 *)(SP<u8>)(v8 + a2);
      BYTE1(v9) = *(u8 *)(SP<u8>)(v6 + a2);
      *v7 = v9;
      LOWORD(v8) = v5[6];
      LOWORD(v6) = v5[7];
      LOBYTE(v8) = a3 + v8;
    ...
    if ( v13 > 0 )
    {
      ...
      while ( v13 )
      {
        ...
        do
        {
          ...
          ++v7;
          ++v6;
            *(v7 - 1) = *(u8 *)(SP<u8>)(v8 + ((int)(intptr_t)tables_start));
          --v5;
        }
        while ( v5 );
        v10 += 320;
  ...
  while ( v8 )
  {
    ...
    if ( (v6 >= 0) && (v6 < vec_window_width) )
    {
      ...
      if ( (v4 >= 0) && (v4 < vec_window_height) && (!*(u8 *)(SP<u8>)(v6 + v4 * vec_screen_width + vec_screen)) )
      {
        ...
        *(u8 *)(SP<u8>)(v6 + v4 * vec_screen_width + vec_screen) = v3;
      }
    }
    v7 = (u8)(v7 + 1);
    v9 = ((u16)v9 + 111) & 0x7FF;
...
int CPP_draw_tube(void) //FINAL
{
  ...
  if ( (u8)no_players <= 1u )
  {
    CPP_setup_vecs(WScreen, 0, 320, 320, 200);
    CPP_set_scroll((int)(u16)word_25677C[0] >> 5);
    CPP_omni_map((int)(intptr_t) tunnelmap, tube_graphics, scrollpos[0]);
  ...
  else
  {
    ...
    CPP_setup_vecs(WScreen + 160, 0, 0, 160, 200);
    CPP_set_scroll((int)(u16)word_25679A >> 5);
    CPP_omni_map((int)(intptr_t) tunnelmap, tube_graphics + 0x10000, word_2567EA[0]);
    CPP_fade_zone(fade_offset, fade_out, (u16)fade_width, (u16)fade_height);
...
char CPP_setup_tube(void) //FINAL
{
  ...
  memset((char*)(SP<char>)tube_graphics, 0, 0x10000u); //CLIB
...
//          if ( ((v3 = scrollsave[i], v5 = HIBYTE(scrollpos[i]), v4 = v3 + 8, v3 == -8) || v4 > 0xF0u) && v5 <= 0x10u )
    ...
    v1 = (unsigned int *)(intptr_t)(HIBYTE(scrollpos[i]) - HIBYTE(scrollpos[i]) % 8); //??? todo
//      v1 = HIBYTE(scrollpos[i]) - HIBYTE(scrollpos[i]) % 8;

    scrollsave[i] = (char)((intptr_t)v1); //??? mingw todo
        ...
        if ( v10 >= 0xBu )
        {
          ...
          else if ( v10 == 12 )
          {
            result = CPP_check_point_with_players(
                       a3,
                       *(UA<u16> *)(u16*)(SP<u16>)(a4 + 4),
                       *(UA<u16> *)(u16*)(SP<u16>)(a4 + 6),
                       *(UA<u16> *)(u16*)(SP<u16>)(a4 + 8),
                       0x300u,
                       0x300u,
                       0x600u);
            goto LABEL_31;
...
LABEL_27:
  ...
  if ( v10 == 49 )
    goto LABEL_25;
LABEL_30:
  result = CPP_check_point_with_players(a3, *(UA<u16> *)(u16*)(SP<u16>)(a4 + 4), *(UA<u16> *)(u16*)(SP<u16>)(a4 + 6), *(UA<u16> *)(u16*)(SP<u16>)(a4 + 8), v11, v12, v13);
LABEL_31:
  if ( result )
  {
    if ( *(u8 *)(SP<u8>)(a4 + 16) == 21 )
    {
//      HIDWORD(v5) = 3;
//      LODWORD(v5) = a3;
...
//    MY_PlaySample(a1, a2, v6, 0x7FFFu, -2 - 0x7FFF * (u8)no_players - 200, 100i64, 3u);
    ...
    else
    {
      ...
      {
        *((u16 *) dword_256784 + 15 * a3 + 1) -= *(UA<u16> *)(u16*)(SP<u16>)(a4 + 14);
...
//      MY_PlaySample(a1, a2, v7, 0x7FFFu, -2 - 0x7FFF * (u8)no_players - 200, 100i64, 3u);
        ...
        *(UA<u16> *)(u16*)(SP<u16>)(a4 + 12) = 0;
        *(u8 *)(SP<u8>)(a4 + 16) = 21;
        *(u8 *)(SP<u8>)(a4 + 24) = 0;
        result = a4;
        *(UA<u16> *)(u16*)(SP<u16>)(a4 + 14) = 127;
      }
      else if ( *(u8 *)(SP<u8>)(a4 + 16) == 11 )
      {
//        HIDWORD(v8) = 7;
//        LODWORD(v8) = a3;
...
char CPP_insert_effect(u16 a1, u16 a2, i16 a3) //FINAL
{
  ...
  {
    v3 = effect_list + 6 * i;
    if ( !*(UA<u16> *)(u16*)(SP<u16>)(v3 + 4) || i >= 0x64u || v6 )
      break;
    if ( *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * i) <= a2 && *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * i + 2) <= a1 )
    {
      v6 = 1;
      if ( *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * i) == a2 && *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * i + 2) == a1 )
      {
        *(UA<u16> *)(u16*)(SP<u16>)(6 * i + effect_list + 2) = a1;
        *(UA<u16> *)(u16*)(SP<u16>)(6 * i + effect_list) = a2;
        *(UA<u16> *)(u16*)(SP<u16>)(6 * i + effect_list + 4) = a3;
      }
      else
      {
        for ( j = i; *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * j + 4) && j < 0x64u; ++j )
          ;
        if ( j != 100 )
        {
          while ( j > i )
          {
            *(UA<u16> *)(u16*)(SP<u16>)(6 * j + effect_list + 2) = *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * (j - 1) + 2);
            *(UA<u16> *)(u16*)(SP<u16>)(6 * j + effect_list)     = *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * (j - 1));
            *(UA<u16> *)(u16*)(SP<u16>)(6 * j + effect_list + 4) = *(UA<u16> *)(u16*)(SP<u16>)(effect_list + 6 * (j - 1) + 4);
            --j;
          }
          *(UA<u16> *)(u16*)(SP<u16>)(6 * i + effect_list + 2) = a1;
          *(UA<u16> *)(u16*)(SP<u16>)(6 * i + effect_list) = a2;
...
//            a1 = 2024;
            *((i16 *)v78 + 5) %= 2024;
            CPP_check_alien_to_players( /* (unsigned int *)0x7E8, a2,*/  i, (int)(intptr_t)v78);
          }
          else
          {
...
LABEL_294:
            CPP_check_alien_to_players(/*(unsigned int *)a1, a2,*/ i, (int)(intptr_t)v78);
          }
          else
          {
...
//          a1 = 1024;
          ...
          *((u16 *)v78 + 6) += 36;
          ...
          {
LABEL_301:
            CPP_check_alien_to_players(/*(unsigned int *)0x400, a2,*/ i, (int)(intptr_t)v78);
          }
          else
          {
...
int CPP_enter_ships(u8 a1) //FINAL
{
  ...
  for ( j = 0; j < 0x3Cu; ++j )
  {
    if ( *((u8 *)v6 + 16) )
    {
      ++v9;
      v2 = (int **)v4++;
      *(UA<uintptr_t> *)v2 = (uintptr_t)v6; // *v2 = v6; misaligned
    }
    v6 = (int *)((char *)v6 + 30);
  }
  *v4 = (int)(intptr_t) players + 30 * a1;
  v4[1] = 0;
  return v9;
}
...
char CPP_change_hit_block(u8 a1, u16 a2, u16 a3) //FINAL
{
  ...
  v6 = *(UA<u16> *)(u16*)(SP<u16>)(level + 2 * (32 * a3 + a2));
  v5 = 0;
  v7 = 0;
  ...
  *(UA<u16> *)(u16*)(SP<u16>)(2 * (32 * a3 + a2) + level) = v6;
...
char CPP_draw_block(int a1, u16 a2) //FINAL
{
  ...
  v2 = a2 << 6;
  v4 = (u32 *)(SP<u32>)(v2 + block_data);

  for ( i = 0; i < 8u; ++i )
  {
    *(UA<u32> *)(u32*)(SP<u32>)(tube_graphics + a1) = *v4;
    *(UA<u32> *)(u32*)(SP<u32>)(tube_graphics + a1 + 4) = v4[1];
    LOBYTE(v2) = i;
    a1 += 256;
    v4 += 2;
  }
...
//  i64 v9; // [esp-1Ch] [ebp-90h]
  ...
  u16 v14=0; // [esp+3Ch] [ebp-38h] warning suppress
  u16 v15; // [esp+40h] [ebp-34h]
  u16 v16=0; // [esp+48h] [ebp-2Ch] warning suppress
  u16 v17=0; // [esp+4Ch] [ebp-28h] warning suppress
  u16 v18=0; // [esp+50h] [ebp-24h] warning suppress
  u8 v19=0; // [esp+54h] [ebp-20h] warning suppress
  u8 v20=0; // [esp+5Ch] [ebp-18h] warning suppress
  u8 v21=0; // [esp+60h] [ebp-14h] warning suppress
  u8 v22=0; // [esp+64h] [ebp-10h] warning suppress
  char i; // [esp+68h] [ebp-Ch]
  u8 v24=0; // [esp+6Ch] [ebp-8h] warning suppress
  ...
  for ( i = 0; (u8)i < 0x3Cu; ++i )
  {
      ...
      && (*((u8 *)v12 + 16) < 0x19u || *((u8 *)v12 + 16) > 0x2Eu) )
    {
      ...
      if ( *(u16 *)(SP<u16>)(a2 + 8) <= v17 + v16 + *((u16 *)v12 + 4)
        && *(u16 *)(SP<u16>)(a2 + 8) >= *((u16 *)v12 + 4) - v17
        && *(u16 *)(SP<u16>)(a2 + 6) <= v17 + v18 + *((u16 *)v12 + 3)
        && *(u16 *)(SP<u16>)(a2 + 6) >= *((u16 *)v12 + 3) - v18 - v17 )
      {
        v13 = *(u16 *)(SP<u16>)(a2 + 4);
        v11 = *((u16 *)v12 + 2);
        v2 = (unsigned int *)(SP<unsigned int>)(v14 + v11 + v17);
        if ( (unsigned int)(uintptr_t)v2 < v11 - v14 - (unsigned int)v17 ) //??? todo
        {
          v11 += 0x2000;
          v13 += 0x2000;
        }
        ...
        {
          i = 60;
          if ( *(UA<u16> *)(u16*)(SP<u16>)(a2 + 14) > *((u16 *)v12 + 7)
            && (*(u8 *)(SP<u8>)(a2 + 16) == 9
             || *(u8 *)(SP<u8>)(a2 + 16) == 10
             || *(u8 *)(SP<u8>)(a2 + 16) == 13
             || *(u8 *)(SP<u8>)(a2 + 16) == 14) )
          {
            *(UA<u16> *)(u16*)(SP<u16>)(a2 + 14) -= *((u16 *)v12 + 7);
            v25 = 0;
          }
          else
          {
...
i16 CPP_move_in_line(int a1, int a2, u16 a3, u16 a4) //FINAL
{
  ...
  v21 = a2 - v14;
  v13 = (int)*(u16 *)(SP<u16>)(a1 + 6) >> 8;
  v26 = (int)a3 >> 8;
  v5 = (u16)v26 - (i16)v13;
  v12 = (int)*(u16 *)(SP<u16>)(a1 + 8) >> 8;
  v27 = (int)a4 >> 8;
  v7 = (u16)v27 - (i16)v12;
  if ( (i16)(a2 - v14) < 0 )
  {
  ...
  *(UA<u16> *)(u16*)(SP<u16>)(a1 + 4) = (u16)v14 << 8;
  *(UA<u16> *)(u16*)(SP<u16>)(a1 + 6) = (u16)v13 << 8;
  result = (u16)v12 << 8;
  *(UA<u16> *)(u16*)(SP<u16>)(a1 + 8) = (u16)v12 << 8;
  return result;
}
...
LABEL_2:
  ...
  {
    v3 = (int)(intptr_t) bullets + 1020 * v139;
    v134 = v3;
    v138 = 0;
    while ( 1 )
    {
      ...
      if ( v133 < 0xAu )
      {
        if ( v133 < 4u )
        {
          if ( v133 >= 2u )
          {
            if ( v133 <= 2u )
            {
              ...
              LOWORD(v4) = *(char *)(SP<char>)(v134 + 24);
              v3 = (v4 SHL8) + (v3 SHL8);
              *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6) += v3;
              if ( *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6) > 0xE000u )
              {
                *(u8 *)(SP<u8>)(v134 + 16) = 0;
                goto LABEL_6;
              }
              ...
              LOWORD(v5) = *(char *)(SP<char>)(v134 + 26);
              v3 = (v5 SHL8) - (v3 SHL8);
              *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4) += v3;
              *(UA<u16> *)(u16*)(SP<u16>)(v134 + 10) += 36;
              *(UA<u16> *)(u16*)(SP<u16>)(v134 + 12) += 48;
              v131 = v134;
              v130 = v134;
              v132 = CPP_check_bullets_to_aliens(/*a2,*/ v134) != 0;
              if ( v132 || (v6 = CPP_what_block(v139, *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6)), CPP_solid_block(v6)) )
              {
                v128 = v139;
                HIWORD(v7) = HIWORD(v134);
                LOWORD(v7) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4);
                v127 = v7;
                HIWORD(v7) = HIWORD(v134);
                LOWORD(v7) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6);
                v126 = v7;
                HIWORD(v7) = HIWORD(v134);
                LOWORD(v7) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8);
                v125[4] = v7;
                v129 = v139;
                v125[3] = v127;
                v125[2] = v126;
              ...
              if ( --*(UA<u32> *)(u32*)(SP<u32>)v134 == (unsigned)-1 ) //unsigned fix
                goto LABEL_106;
            }
            else
            {
              HIWORD(v8) = HIWORD(v134);
              LOWORD(v8) = *(char *)(SP<char>)(v134 + 24);
              v8 OSHL8;
              v9 = v8;
              ...
              *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6) += v3;
              ...
              LOWORD(v10) = *(char *)(SP<char>)(v134 + 26);
              v3 = (v10 SHL8) - (v3 SHL8);
              *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4) += v3;
              *(UA<u16> *)(u16*)(SP<u16>)(v134 + 10) += 36;
              *(UA<u16> *)(u16*)(SP<u16>)(v134 + 12) += 48;
              ...
              if ( v123 || (v11 = CPP_what_block(1u, *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6)), CPP_solid_block(v11)) )
              {
                v119 = 1;
                HIWORD(v12) = HIWORD(v134);
                LOWORD(v12) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4);
                v118 = v12;
                HIWORD(v12) = HIWORD(v134);
                LOWORD(v12) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6);
                v117 = v12;
                HIWORD(v12) = HIWORD(v134);
                LOWORD(v12) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8);
                v116[4] = v12;
                v120 = 1;
                v116[3] = v118;
                v116[2] = v117;
        ...
        else if ( v133 <= 4u )
        {
          ...
          LOWORD(v13) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4);
          v137 = v13;
          v135 = 57344;
          HIWORD(v13) = HIWORD(v134);
          LOWORD(v13) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8);
          v136 = v13;
          CPP_nearest_alien(0, *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8), (u16*)&v137, (u16*)&v135, (u16*)&v136);
          CPP_move_in_line(v134, (u16)v137, v135, v136);
          if ( *(u8 *)(SP<u8>)(v134 + 24) != 8 && (turn & 3) == 0 )
            ++*(u8 *)(SP<u8>)(v134 + 24);
          if ( *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6) >= 0xE000u )
          {
            *(u8 *)(SP<u8>)(v134 + 16) = 0;
          ...
          *(UA<u16> *)(u16*)(SP<u16>)(v134 + 10) += 72;
          v113 = v134;
          v112 = v134;
          v114 = CPP_check_bullets_to_aliens(/*a2,*/ v134) != 0;
          if ( v114 || (v14 = CPP_what_block(v139, *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6)), CPP_solid_block(v14)) )
          {
            v110 = v139;
            HIWORD(v15) = HIWORD(v134);
            LOWORD(v15) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4);
            v109 = v15;
            HIWORD(v15) = HIWORD(v134);
            LOWORD(v15) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6);
            v108 = v15;
            HIWORD(v15) = HIWORD(v134);
            LOWORD(v15) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8);
            v107[4] = v15;
            v111 = v139;
            v107[3] = v109;
            v107[2] = v108;
        ...
        else if ( v133 <= 5u )
        {
          ...
          LOWORD(v16) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4);
          v137 = v16;
          v135 = 57344;
          HIWORD(v16) = HIWORD(v134);
          LOWORD(v16) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8);
          v136 = v16;
          CPP_nearest_alien(1u, *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8), (u16*)&v137, (u16*)&v135, (u16*)&v136);
          CPP_move_in_line(v134, (u16)v137, v135, v136);
          if ( *(u8 *)(SP<u8>)(v134 + 24) != 8 && (turn & 3) == 0 )
            ++*(u8 *)(SP<u8>)(v134 + 24);
          if ( *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6) >= 0xE000u )
          ...
          *(UA<u16> *)(u16*)(SP<u16>)(v134 + 10) += 72;
          ...
          if ( v105 || (v17 = CPP_what_block(1u, *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6)), CPP_solid_block(v17)) )
          {
            v101 = 1;
            HIWORD(v18) = HIWORD(v134);
            LOWORD(v18) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4);
            v100 = v18;
            HIWORD(v18) = HIWORD(v134);
            LOWORD(v18) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6);
            v99 = v18;
            HIWORD(v18) = HIWORD(v134);
            LOWORD(v18) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8);
            v98[4] = v18;
            v102 = 1;
            v98[3] = v100;
            v98[2] = v99;
        ...
        else if ( v133 == 9 )
        {
          ...
          LOWORD(v23) = *(char *)(SP<char>)(v134 + 24);
          v3 = (v23 SHL8) + (v3 SHL8);
          *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6) += v3;
          if ( *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6) > 0xE000u || *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8) > 0xE000u )
          {
            *(u8 *)(SP<u8>)(v134 + 16) = 0;
            goto LABEL_6;
          }
          ...
          if ( v78 || (v24 = CPP_what_block(v139, *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6)), CPP_solid_block(v24)) )
          {
            *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4) -= vx[v139]  SHL8; //shift fix
            v75 = v139;
            HIWORD(v25) = HIWORD(v134);
            LOWORD(v25) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4);
            v73 = v25;
            HIWORD(v25) = HIWORD(v134);
            LOWORD(v25) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6);
            v72 = v25;
            HIWORD(v25) = HIWORD(v134);
            LOWORD(v25) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8);
            v71[4] = v25;
            v74 = v139;
            v71[3] = v73;
            v71[2] = v72;
      ...
      else if ( v133 <= 0xAu )
      {
        ...
        LOWORD(v26) = *(char *)(SP<char>)(v134 + 24);
        v26 OSHL8;
        v27 = v26;
        ...
        *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6) += v3;
        ...
        if ( v69 || (v28 = CPP_what_block(1u, *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6)), CPP_solid_block(v28)) )
        {
          *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4) -= vx[v139]  SHL8; //shift fix
          v66 = 1;
          HIWORD(v29) = HIWORD(v134);
          LOWORD(v29) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4);
          v64 = v29;
          HIWORD(v29) = HIWORD(v134);
          LOWORD(v29) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6);
          v63 = v29;
          HIWORD(v29) = HIWORD(v134);
          LOWORD(v29) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8);
          v62[4] = v29;
          v65 = 1;
          v62[3] = v64;
          v62[2] = v63;
      ...
      else if ( v133 < 0x29u )
      {
        if ( v133 >= 0xDu )
        {
          if ( v133 <= 0xDu )
          {
            ...
            CPP_nearest_alien(0, *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8), (u16*)&v137, (u16*)&v135, (u16*)&v136);
            CPP_move_in_line(v134, (u16)v137, v135, v136);
            if ( *(u8 *)(SP<u8>)(v134 + 24) != 12 && (turn & 3) == 0 )
              ++*(u8 *)(SP<u8>)(v134 + 24);
            if ( *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6) >= 0xE000u )
            {
              *(u8 *)(SP<u8>)(v134 + 16) = 0;
            ...
            *(UA<u16> *)(u16*)(SP<u16>)(v134 + 10) += 36;
            ...
            if ( v60 || (v33 = CPP_what_block(v139, *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6)), CPP_solid_block(v33)) )
            {
              v56 = v139;
              HIWORD(v34) = HIWORD(v134);
              LOWORD(v34) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4);
              v55 = v34;
              HIWORD(v34) = HIWORD(v134);
              LOWORD(v34) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6);
              v54 = v34;
              HIWORD(v34) = HIWORD(v134);
              LOWORD(v34) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8);
              v53[4] = v34;
              v57 = v139;
              v53[3] = v55;
              v53[2] = v54;
          ...
          else if ( v133 == 14 )
          {
            ...
            *(UA<u16> *)(u16*)(SP<u16>)(v134 + 10) += 36;
            ...
            if ( v51 || (v37 = CPP_what_block(1u, *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6)), CPP_solid_block(v37)) )
            {
              v47 = 1;
              HIWORD(v38) = HIWORD(v134);
              LOWORD(v38) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4);
              v46 = v38;
              HIWORD(v38) = HIWORD(v134);
              LOWORD(v38) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6);
              v45 = v38;
              HIWORD(v38) = HIWORD(v134);
              LOWORD(v38) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8);
              v44[4] = v38;
              v48 = 1;
              v44[3] = v46;
              v44[2] = v45;
...
LABEL_136:
              *(UA<u16> *)(u16*)(SP<u16>)(v134 + 10) = 0;
              *(UA<u16> *)(u16*)(SP<u16>)(v134 + 12) = 0;
              v39 = 100;
...
//              LODWORD(v42) = v139;
      ...
      else
      {
        ...
        if ( v133 <= 0x2Fu )
        {
          *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4) += *(char *)(SP<char>)(v134 + 24)  SHL8; //shift fix
          v3 = *(UA<i32> *)(i32*)(SP<i32>)(v134 + 22) >> 24;
          if ( (int)*(u16 *)(u16*)(SP<u16>)(v134 + 4) >> 11 == v3 )
            goto LABEL_106;
          *(UA<u16> *)(u16*)(SP<u16>)(v134 + 10) += 72;
          v95 = v134;
          v94 = v134;
          v96 = CPP_check_bullets_to_aliens(/*a2,*/ v134) != 0;
          if ( v96 || (v19 = CPP_what_block(v139, *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6)), CPP_solid_block(v19)) )
          {
            v92 = v139;
            HIWORD(v20) = HIWORD(v134);
            LOWORD(v20) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4);
            v91 = v20;
            HIWORD(v20) = HIWORD(v134);
            LOWORD(v20) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6);
            v90 = v20;
            HIWORD(v20) = HIWORD(v134);
            LOWORD(v20) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8);
            v89[4] = v20;
            v93 = v139;
            v89[3] = v91;
            v89[2] = v90;
        ...
        {
          *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4) += *(char *)(SP<char>)(v134 + 24) SHL8;
          v3 = *(UA<i32> *)(i32*)(SP<i32>)(v134 + 22) >> 24;
          if ( (int)*(u16 *)(u16*)(SP<u16>)(v134 + 4) >> 11 == v3 )
            goto LABEL_106;
          *(UA<u16> *)(u16*)(SP<u16>)(v134 + 10) += 72;
          ...
          if ( v87 || (v21 = CPP_what_block(1u, *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4), *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6)), CPP_solid_block(v21)) )
          {
            v83 = 1;
            HIWORD(v22) = HIWORD(v134);
            LOWORD(v22) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 4);
            v82 = v22;
            HIWORD(v22) = HIWORD(v134);
            LOWORD(v22) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 6);
            v81 = v22;
            HIWORD(v22) = HIWORD(v134);
            LOWORD(v22) = *(UA<u16> *)(u16*)(SP<u16>)(v134 + 8);
            v80[4] = v22;
            v84 = 1;
            v80[3] = v82;
            v80[2] = v81;
...
i16 CPP_what_block(u8 a1, u16 a2, u16 a3) //FINAL
{
  ...
  if ( lastscroll[a1] == 1 )
    ...
    v5 = (((v4 - (__CFSHL__(v4 >> 31, 3) + 8 * (v4 >> 31))) >> 3) - 4 + (u16)level_line[a1] + 1027) % 1024;
  return *(UA<u16> *)(u16*)(SP<u16>)(level + 2 * (32 * (u16)(1023 - v5) + (u16)v7));
}
...
char CPP_change_block(u8 a1, u16 a2, u16 a3) //FINAL
{
  ...
  v8 = 0;
  v7 = *(UA<u16> *)(u16*)(SP<u16>)(level + 2 * (32 * a3 + a2));
  ...
  *(UA<u16> *)(u16*)(SP<u16>)(2 * (32 * a3 + a2) + level) = v7;
  if ( lastscroll[a1] == 1 )
    v3 = (a1 << 16)
       + (((((int)HIBYTE(scrollpos[a1]) >> 3) + (a3 + (u16)level_line[a1]) % 1024) % 32) << 11);
  else
...
//  i64 v22; // [esp-1Ch] [ebp-30h]
  ...
  u8 v32=0; // [esp+10h] [ebp-4h] warning suppress
...
//        MY_PlaySample((unsigned int *)a1, a2, v18, 0x7FFFu, -2 - 0x7FFF * (u8)no_players - 200, 100i64, 3u);
        ...
        *(UA<u16> *)&v23[30 * i + 6] = v4;
        a1 = (int)(intptr_t)&v23[30 * i];
        *(UA<u16> *)(u16*)(SP<u16>)(a1 + 8) = *((u16 *) dword_256780 + 15 * a3);
        *(UA<u16> *)(u16*)(SP<u16>)(a1 + 12) = 0;
        *(UA<u16> *)(u16*)(SP<u16>)(a1 + 10) = 0;
        *(UA<u16> *)(u16*)(SP<u16>)(a1 + 14) = 10;
        ++i;
        while ( v23[30 * i + 16] && i < 0x22u )
          ++i;
      }
    ...
    if ( i < 0x22u )
    {
      ...
      if ( !*((u8 *) dword_25678D + 30 * a3) )
      {
        if ( (v8 = 30 * a3,
              ...
              v33 = (char)((int)(intptr_t)v7), //??? mingw todo
              (u8)((int)(intptr_t)v7) < *((u8 *) dword_25678D + v8 + 2)) //??? mingw todo
          && (v8 = 28 / *((u8 *) dword_25678D + 30 * a3 + 2),
              v7 = (char *)(SP<char>)abs(turn - dword_29F6B4[a3]),
              (int)(intptr_t)v7 > v8)
          || !v33 )
        {
//          HIDWORD(v20) = 1;
...
//          MY_PlaySample((unsigned int *)v8, a2, v20, 0x7FFFu, -2 - 0x7FFF * (u8)no_players - 200, 100i64, 3u);
         ...
         || ((v10 = *((u8 *) dword_25678D + 30 * a3 + 2),
          ...
          || (a1 = 28 / (*((u8 *) dword_25678D + 30 * a3 + 2) / 3),
              v7 = (char *)(intptr_t)abs(turn - dword_29F6B4[a3]),
              (int)(intptr_t)v7 <= a1))
         && v32 >= 3u )
  {
    if ( i < 0x22u
...
//      MY_PlaySample((unsigned int *)a1, a2, v21, 0x7FFFu, -2 - 0x7FFF * (u8)no_players - 200, 100i64, 3u);
  ...
  return (char)((int)(intptr_t)v7); //??? mingw todo
}
    ...
    if ( (!flicker[i] || !level_start) && !game_over_flag[i] )
    {
      ...
      if ( !v54 ) //ранее это условие не выполнялось, если v54 - char.  Была порча памяти? Спасало глобальное объявление, либо int
      {
        if ( joysx[i] )
        {
          ...
          v3 = (unsigned int *)(SP<unsigned int>)(30 * i);
          *((u8 *) dword_256791 + (u32)(uintptr_t)v3 + 1) += *((u8 *) dword_256791 + (u32)(uintptr_t)v3) * -LOBYTE(joysx[i]);
          if ( v52 >= 0 )
            v51 = v52 > 0;
          else
            v51 = -1;
...
int CPP_check_anim(u16 a1, u16 *a2) //FINAL
{
  ...
  {
    v3 = *i;
    for ( j = 0; *(UA<i16> *)(i16*)(SP<i16>)(v3 + 2 * j) >= 0 && !v7; ++j )
    {
      if ( *(UA<i16> *)(i16*)(SP<i16>)(v3 + 2 * j) == a1 )
      {
        v7 = 1;
        *a2 = j;
        v5 = v3;
...
int CPP_setup_high_scores(void) //FINAL
{
  ...
  memset((char*)(SP<char>)tube_graphics, 0, 0x10000u);
...
unsigned int CPP_load_game(void) //FINAL
{
  ...
  if ( tabgen )
  {
    v4 = (u16 *)(SP<u16>)high_scores;
    v5 = (u16 *)(SP<u16>)high_scores;
    for ( i = 0; ; ++i )
    {
  ...
  {
    result = CPP_LoadFileAt(aDataHiscoreDat, (char *)(SP<char>)high_scores);
...
int CPP_tunnel_table(void) //FINAL
{
  ...
  for ( i = 0; i < 0x10000; ++i )
  {
    ...
    LOBYTE(v0) = *v0;
    v1 = v11++;
    *v1 = 255 - (u8)((int)(intptr_t)v0); //??? mingw todo
  }
  ...
  result = CPP_SaveFileAt(aDataTunnelDat, tunnelmap, 0x20000);
...
int CPP_find_distant(void) //FINAL
{
  ...
  v9 = 199;
  v8 = 0;
  v5 = (int)(intptr_t)tunnelmap; //2320192; //0x236740 HARDCODE !!!
  for ( i = 0; i < 0xC8u; ++i )
  {
    for ( j = 0; j < 0x140u; ++j )
    {
  ...
  fade_width = v1;
  fade_height = v8 - v9;
  fade_out = (SP<int>)Malloc(v1 * (u16)(v8 - v9));
...
char CPP_setup_tube_graphics(int a1) //FINAL
{
  ...
  for ( i = 0; i < 0x20u; ++i )
  {
    for ( j = 0; j < 0x20u; ++j )
    {
      ...
      for ( k = 0; k < 8u; ++k )
      {
        ...
        {
          v4 = (u8 *)(SP<u8>)v9++;
          *(u8 *)(SP<u8>)((i << 11) + 8 * j + (k << 8) + l + tube_graphics) = *v4;
        }
      }
    }
    LOBYTE(v1) = i;
  ...
  while ( v7 < 0x10000 )
  {
    *(UA<u32> *)(u32*)(SP<u32>)(tube_graphics + v6) = *(UA<u32> *)(u32*)(SP<u32>)(tube_graphics + v7);
    v1 = *(UA<u32> *)(u32*)(SP<u32>)(tube_graphics + v7 + 4);
    *(UA<u32> *)(u32*)(SP<u32>)(tube_graphics + v6 + 4) = v1;
    v7 += 8;
    v6 += 8;
  }
  return v1;
...
int CPP_setup_stuff(void) //FINAL
{
  ...
  if ( tabgen )
  {
    ...
    while ( v4 < 0x20u )
    {
      CPP_make_fade_table((u8 *)(SP<u8>)palette, (u8 *)&tables_start[256 * v4++], 0, 0, 0, v2, v2, v2);
      v2 -= 8;
    }
    v5 = 32;
    v3 = 0;
    ...
    while ( v5 < 0x40u )
    {
      CPP_make_fade_table((u8 *)(SP<u8>)palette, (u8 *)&tables_start[256 * v5++], 63, 63, 63, v3, v3, v3);
      v3 += 6;
    }
    ...
    for ( i = 0; i < 0x100u; ++i )
      CPP_make_fade_table(
        (u8 *)(SP<u8>)palette,
        (u8 *)&ghost[256 * i],
        *(u8 *)(SP<u8>)(3 * i + palette),
        *(u8 *)(SP<u8>)(3 * i + palette + 1),
        *(u8 *)(SP<u8>)(3 * i + palette + 2),
        85,
        85,
        85);

    result = CPP_SaveFileAt(aDataTablesDat, tables_start, 82176);
...
int CPP_SaveFileAt(char *a1, void *a2, int a3) //FINAL
{
  FILE *result; // eax
  FILE *v4; // ebx
  int v5=0; // esi
...
int CPP_MyWrite(FILE *a1, void *a2, int a3) //FINAL
{
 return fwrite(a2,1,a3,a1);
}
...
void CPP_make_fade_table(u8 *A2, u8 *A3, signed char a4, signed char a5, signed char a6, short a7, short a8, short a9) //FINAL
{
    ...
    signed char al27;
    short dx28;
    signed char v29=0; //warning suppress
    ...
    do {
        ...
        bl14 = (signed char)(esi10->f0 + *(signed char*)(SP<signed char>)((int)(intptr_t)(&ax13) + 1));
        ax15 = (short)((signed char)(a5 - esi10->f1) * a8);
        bh16 = (signed char)(esi10->f1 + *(signed char*)(SP<signed char>)((int)(intptr_t)(&ax15) + 1));
        ax17 = (short)((signed char)(a6 - esi10->f2) * a9);
        cl18 = (signed char)(esi10->f2 + *(signed char*)(SP<signed char>)((int)(intptr_t)(&ax17) + 1));
        v19 = esi10;
        esi20 = a2;
        v21 = 0x7fff;
        ch22 = 0;
...
void CPP_LoadAllData(char *a2) //FINAL
{
  char *v2; // ebx
  i16 v3; // si
  char *v4; // ebx
...
void CPP_load_all_tmaps(void) //FINAL
{
  ...
  for(;v9<2;v9++) //do
  {
   sprintf((char*)&MINIBuf[44*v9],(char*)aDataTex02dDat, v9);

   uintptr_t esp=(uintptr_t)&MINIBuf[44*v9];
   *(u32*)(esp+28)=(u32)(uintptr_t)&tmaps[v9];
   *(u32*)(esp+32)=0;
   *(u32*)(esp+36)=0;
   *(u16*)(esp+40)=0;
   *(u16*)(esp+42)=0;

   v10 = CPP_LoadData(&MINIBuf[44*v9]);
   //++v9;
  }
...
void CPP_load_all_3d_files(void) //FINAL
{
  ...
  if ( CPP_LoadFileAt(aData3dobsDat, object3ds) != -1 )
    no_object3ds = (unsigned int)CPP_RncFileLength(aData3dobsDat) >> 4;

  if ( CPP_LoadFileAt(aData3dpointsDa, point3ds) != -1 )
    no_point3ds = CPP_RncFileLength(aData3dpointsDa) / 0xCu;

  v0 = CPP_LoadFileAt(aData3dfacesDat, face3ds);

  if ( v0 != -1 )
  {
    v0 = CPP_RncFileLength(aData3dfacesDat) / 0xFu;
    no_face3ds = v0;
  }
  if ( no_object3ds )
  {
    ...
    for ( i = (int)(intptr_t)object3ds; ; i += 16 )
    {
      LOWORD(v0) = v6;
      if ( v6 == no_object3ds )
        break;
      if ( *(UA<u32> *)(u32*)(SP<u32>)(i + 8) )
      {
        *(UA<u32> *)(u32*)(SP<u32>)(i + 8) = (u32)(uintptr_t)&point3ds[*(UA<u32> *)(u32*)(SP<u32>)(i + 8) - 1];
        if ( *(UA<u32> *)(u32*)(SP<u32>)(i + 8) > v5 )
        {
          v5 = *(UA<u32> *)(u32*)(SP<u32>)(i + 8);
          selected_object = v6;
        }
      }
      if ( *(UA<u32> *)(u32*)(SP<u32>)(i + 12) )
        *(UA<u32> *)(u32*)(SP<u32>)(i + 12) = (u32)(uintptr_t)&face3ds[*(UA<u32> *)(u32*)(SP<u32>)(i + 12) - 1];
      ++v6;
    }
  }
  v7 = 256;
...
//  CPP_FadePalette256(0, 0x10u, 0); //гашение DOS'овской консоли - здесь это не нужно
  ...
  CPP_SetupScreenMCGA((u8 *)(SP<u8>)WScreen);

  CPP_setup_vecs(WScreen, 0, 320, 320, 200);
}

void CPP_KInt(void) //SDL2
{
 SDL_Event Event;
 int sdlk;
...
void CPP_setup_a_sprite(unsigned int a1, unsigned int a2, unsigned int a3) //FINAL
{
  ...
  while ( 1 )
  {
    ...
    if ( *(UA<u32> *)(u32*)(SP<u32>)a1 < a3 )
      *(UA<u32> *)(u32*)(SP<u32>)a1 += a3;
...
int CPP_LoadData(char *a3) //FINAL
{
  #define add_patch 0x1000 /* fix little buffer overflow */
  ...
  if ( *(u8 *)a3 == 42 )
  {
    v3 = (SP<int>)CPP_MyAlloc( (*(UA<u32> *)(a3 + 36)) + add_patch);
    **(SP<u32>)(a3 + 28) = v3;
  ...
  if ( v7 )
    *v7 = *(UA<u32> *)(a3 + 36) + **(SP<u32>)(a3 + 28);

  return 1;
}

void CPP_FreeData(char *a1) //FINAL
{
  int result; // eax
  ...
  if ( result )
  {
   CPP_MyFree((void*)(SP<void>)result);
...
void CPP_MyFree(void *a1) //FINAL
{
// printf("free 0x%016llx\n",a1);
 if(a1)Free(a1);
}

int CPP_LoadFileAt(char *a1, char *a2) //FINAL
{
  FILE *result; // eax
  FILE *v3; // ebx
  int v4=0; // esi

  result = CPP_MyOpen(a1, 512);
  v3 = result;

  if (result)
  {
    v4 = CPP_RncFileLength(a1);
    CPP_MyRead(v3, a2, v4);
    CPP_MyClose(v3);
  }
...
int CPP_RncFileLength(char *a1) //FINAL
{
  FILE *v1; // ebx
  FILE *v2; // esi
  int v3; // ebx
  ...
  if ( !strncmp((char*)v5, (char*)v6, 4) ) //CLIB
    v3 = (u8)v5[7]
...
FILE *CPP_MyOpen(char *a1, int a2) //FINAL
{
  FILE *v2; // ebx
  ...
  return fopen(ffn,"r+b");
}

int CPP_MyRead(FILE *a1, void *a2, int a3) //FINAL
{
   return fread(a2,1,a3,a1); //CLIB
}

int CPP_MyClose(FILE *a1) //FINAL
{
    return fclose(a1); //CLIB
}
...
void CPP_SetupScreenMCGA(u8 *a1) //SDL2
{
 ...
 window=SDL_CreateWindow("Tube64",SDL_WINDOWPOS_CENTERED,SDL_WINDOWPOS_CENTERED,320*SCALE,200*SCALE,SDL_WINDOW_SHOWN);
 if(!window)
 {
  printf("error!\n");
  exit(-1);
